...
namespace AssignmentGD1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDistributedMemoryCache(); // Đăng ký dịch vụ lưu cache trong bộ nhớ (Session using)
            services.AddSession(option => { option.IdleTimeout = TimeSpan.FromMinutes(30); });//kéo dài 30p
